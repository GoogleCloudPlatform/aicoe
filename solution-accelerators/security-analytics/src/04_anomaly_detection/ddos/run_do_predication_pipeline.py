...
import pipeline_do_online_prediction
...
compiler.Compiler().compile(
    pipeline_func=pipeline_do_online_prediction.pipeline,
    package_path="../generated/ddos-do_online_prediction.json"
    )

job = aip.PipelineJob(
    display_name=f"s04-ddos-do-online-prediction-{str(uuid.uuid1())}",
    template_path="../generated/ddos-do_online_prediction.json",
