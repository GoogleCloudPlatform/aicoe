...
import pipeline_detect_publish
...
compiler.Compiler().compile(
    pipeline_func=pipeline_detect_publish.pipeline,
    package_path="../generated/detect_publish_pipeline.json",
)
...
job = aip.PipelineJob(
    ...
    template_path="../generated/detect_publish_pipeline.json",
    ...
    parameter_values={
        ...
        "bqml_artifact_uri": f"https://www.googleapis.com/bigquery/v2/projects/{containersec_settings['PROJECT_ID']}/datasets/{containersec_settings['PIPELINE_LAUNCH_PARAMS']['MODEL_TARGET_DATASET']}/models/{containersec_settings['PIPELINE_LAUNCH_PARAMS']['MODEL_TARGET_NAME']}",
        "bqml_dataset_id": containersec_settings['PIPELINE_LAUNCH_PARAMS']['MODEL_TARGET_DATASET'],
        "bqml_model_id": containersec_settings['PIPELINE_LAUNCH_PARAMS']['MODEL_TARGET_NAME'],
    },
)
